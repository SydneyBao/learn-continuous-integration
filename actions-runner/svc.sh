...
SVC_NAME="actions.runner.SydneyBao-learn-continuous-integration.Sydney-Macbook"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (SydneyBao-learn-continuous-integration.Sydney-Macbook)"
